                        ...
                        <div className="relative z-10 mx-auto w-full max-w-7xl px-6">
                            <div className="md:w-1/2">
                                <div>
                                    ...
                                    <p className="text-muted-foreground my-8 max-w-2xl text-balance text-xl">Welcome to Masterminds Day care, a supportive space and a locally operated nonprofit daycare in Lethbridge, Alberta. Our mission is to provide a safe, inclusive, and enriching environment where children are empowered to explore, grow, and thrive.</p>
